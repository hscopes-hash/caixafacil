...
const PLANOS_SUGESTOES: PlanoSugestao[] = [
  ...
  },
  {
    ...
    features: ['Ate 100 clientes', '5 usuarios', '50 maquinas', 'IA Vision (OCR)', 'Relatorios avancados', 'Backup automatico', 'Suporte prioritario', '2 meses gratis no plano anual'],
  },
  {
    id: 'empresarial',
    nome: 'Empresarial',
