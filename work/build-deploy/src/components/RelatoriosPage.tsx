...
export default function RelatoriosPage({ empresaId }: { empresaId: string }) {
  ...
  const generatePrintHTML = () => {
    const title = `${configAtual?.label || 'Relatório'} - CaixaFácil`;
    let tableRows = '';
...
<body>
  <div class="header">
    <h1>📊 ${title}</h1>
    <p>CaixaFácil - Sistema de Gestão</p>
  ...
  <div class="footer">
    <p>Relatório gerado automaticamente pelo CaixaFácil</p>
  </div>
</body>
</html>`;
  };
