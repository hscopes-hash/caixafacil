...
import { callAI, loadAIConfig } from '@/lib/ai-vision';
...
{"tickets": [{"valor": 100.00}, {"valor": 30.00}, {"valor": 45.50}],"total": 175.50}`;
    ...
    console.log(`[EXTRAIR-CARTAO] Modelo: ${model}`);
    ...
    console.log(`[EXTRAIR-CARTAO] Conteúdo extraído:`, content.substring(0, 300));
    ...
    if (!somaConferida) {
      console.log(`[EXTRAIR-CARTAO] DISCREPANCIA: IA disse ${totalIA} | Código calculou ${totalCalculado} | Diferença: ${(totalCalculado - totalIA).toFixed(2)}`);
    }
